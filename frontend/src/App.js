      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="w-24 h-px bg-gradient-to-r from-beige-500 to-warmStone-500 mx-auto mb-8"></div>
          </motion.div>
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(196, 184, 164, 0.4)" }}
            className="bg-gradient-to-r from-beige-500 to-warmStone-500 text-white px-12 py-4 rounded-full text-lg font-medium hover:from-beige-600 hover:to-warmStone-600 transition-all duration-300 inline-flex items-center gap-3 shadow-2xl"
          >
            Book Your Session
            <ArrowRight size={20} />
          </motion.button>
      ...
      <section className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-br from-dustyRose-500/20 to-dustyRose-600/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500"></div>
              <div className="relative bg-stone-900/50 border border-stone-800 p-8 rounded-2xl hover:border-dustyRose-500/50 transition-all duration-500">
                <div className="relative overflow-hidden rounded-2xl mb-8 aspect-[4/3]">
                  ...
                  />
                  <div className="absolute inset-0 bg-dustyRose-950/40 group-hover:bg-dustyRose-950/20 transition-colors duration-500"></div>
                  <div className="absolute top-4 right-4">
                    <div className="w-3 h-3 bg-dustyRose-500 rounded-full animate-pulse"></div>
                  </div>
                </div>
                <h3 className="text-3xl font-serif text-stone-100 mb-4 group-hover:text-dustyRose-300 transition-colors duration-300">Sports Massage</h3>
                ...
                <ul className="space-y-2 text-stone-400">
                  <li className="flex items-center gap-3">
                    <CheckCircle size={16} className="text-dustyRose-500" />
            ...
            <motion.div
              ...
              className="group relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-sage-500/20 to-sage-600/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500"></div>
              <div className="relative bg-stone-900/50 border border-stone-800 p-8 rounded-2xl hover:border-sage-500/50 transition-all duration-500">
                <div className="relative overflow-hidden rounded-2xl mb-8 aspect-[4/3]">
                  <img 
                    ...
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-sage-950/40 group-hover:bg-sage-950/20 transition-colors duration-500"></div>
                  <div className="absolute top-4 right-4">
                    <div className="w-3 h-3 bg-sage-500 rounded-full animate-pulse"></div>
                  </div>
                </div>
                <h3 className="text-3xl font-serif text-stone-100 mb-4 group-hover:text-sage-300 transition-colors duration-300">Stress Relief</h3>
                <p className="text-stone-300 text-lg leading-relaxed mb-6">
            ...
            <motion.div
              ...
              className="group relative"
            >
              <div className="absolute inset-0 bg-gradient-to-br from-beige-500/20 to-warmStone-500/20 rounded-2xl blur-lg group-hover:blur-xl transition-all duration-500"></div>
              <div className="relative bg-stone-900/50 border border-stone-800 p-8 rounded-2xl hover:border-beige-500/50 transition-all duration-500">
                <div className="relative overflow-hidden rounded-2xl mb-8 aspect-[4/3]">
                  <img 
                    ...
                    className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-beige-950/40 group-hover:bg-beige-950/20 transition-colors duration-500"></div>
                  <div className="absolute top-4 right-4">
                    <div className="w-3 h-3 bg-beige-500 rounded-full animate-pulse"></div>
                  </div>
                </div>
                <h3 className="text-3xl font-serif text-stone-100 mb-4 group-hover:text-beige-300 transition-colors duration-300">Therapeutic Wellness</h3>
                <p className="text-stone-300 text-lg leading-relaxed mb-6">
                ...
                <ul className="space-y-2 text-stone-400">
                  <li className="flex items-center gap-3">
                    <CheckCircle size={16} className="text-beige-500" />
                    Pain management
                  </li>
                  <li className="flex items-center gap-3">
                    <CheckCircle size={16} className="text-beige-500" />
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div className="flex-shrink-0 w-3 h-3 bg-gradient-to-r from-beige-500 to-warmStone-500 rounded-full mt-3 shadow-lg"></div>
                    <div>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-beige-500 to-warmStone-500 text-white px-6 py-3 rounded-full text-sm font-medium shadow-lg">
                      ⭐ Most Popular
                    </span>
                  </div>
                )}
                ...
                <button className={`w-full py-4 rounded-full font-medium transition-all duration-300 ${
                  plan.popular
                    ? 'bg-gradient-to-r from-beige-500 to-warmStone-500 text-white hover:from-beige-600 hover:to-warmStone-600 shadow-lg'
                    : 'bg-gradient-to-r from-beige-500 to-warmStone-500 text-white hover:from-beige-600 hover:to-warmStone-600'
                }`}>
                  Book Now
                </button>
              </motion.div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 text-stone-300">
                <MapPin size={24} className="text-dustyRose-500" />
                <div>
              ...
              <div className="flex items-center gap-4 text-stone-300">
                <Clock size={24} className="text-warmStone-500" />
                <div>
            ...
            <div className="bg-stone-900/60 backdrop-blur-sm p-8 rounded-2xl border border-stone-800">
              ...
              <form className="space-y-4">
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-beige-500 to-warmStone-500 text-white py-4 rounded-lg font-medium hover:from-beige-600 hover:to-warmStone-600 transition-all duration-300 shadow-lg"
                >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(196, 184, 164, 0.4)" }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-beige-500 to-warmStone-500 text-white px-12 py-6 rounded-full text-xl font-medium hover:from-beige-600 hover:to-warmStone-600 transition-all duration-300 inline-flex items-center gap-3 shadow-2xl"
          >
            Call Now to Book
            <Phone size={24} />
          </motion.button>
