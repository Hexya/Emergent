      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          <motion.button
            ...
            viewport={{ once: true }}
            className="bg-gradient-to-r from-amber-500 to-orange-500 text-white px-12 py-6 rounded-full text-xl font-medium hover:from-amber-600 hover:to-orange-600 transition-all duration-300 inline-flex items-center gap-3 shadow-2xl"
          >
            Call Now to Book
            <Phone size={24} />
          </motion.button>
